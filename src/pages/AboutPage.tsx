      ...
      <section className="container py-4">
        ...
        <section className="row justify-content-center">
          <section className="col-lg-8">
            ...
            {/* ─── Block 4: Language Learning Achievement ───────── */}
            <article className="card-like mb-4">
              <p className="mb-2"><strong>Language Learning Achievement</strong></p>
              <ul className="mb-0">
                <li>
                  <img
                    src="/images/education/ielts.png"
                    alt="IELTS Logo"
                ...
                <li>
                  <img
                    src="/images/education/norwegian.png"
                    alt="Norwegian flag"
                    style={{ height: "1.2em", marginRight: "0.5em" }}
                  />
                  Norwegian language training up to <strong>B1</strong> (working toward B2)
                </li>
              </ul>
            </article>
          </section>
